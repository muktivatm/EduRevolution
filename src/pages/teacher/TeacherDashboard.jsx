                        ...
                        <div key={cl.id} className="glass-card" style={{ padding: '0', overflow: 'hidden', position: 'relative', borderRadius: '16px' }}>
                            <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                    ...
                                    <div>
                                        <h3 style={{ fontSize: isMobile ? '1.1rem' : '1.4rem', fontWeight: 'bold', color: '#1f2937', marginBottom: '0' }}>{cl.name}</h3>
                                        <p style={{ color: '#6b7280', fontSize: isMobile ? '0.85rem' : '0.95rem' }}>{cl.students} Students</p>
                                    </div>
                                </div>
                                <span style={{ fontSize: isMobile ? '0.7rem' : '0.8rem', fontWeight: '600', padding: '0.2rem 0.6rem', borderRadius: '20px', background: '#e0e7ff', color: '#3730a3' }}>
                                    {cl.subject}
                                </span>
                            </div>
                            ...
                            <div style={{ padding: isMobile ? '0.75rem 1rem' : '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                    <p style={{ fontSize: isMobile ? '0.75rem' : '0.8rem', color: '#6b7280' }}>Next: <span style={{ fontWeight: '600', color: '#111827' }}>{cl.nextClass}</span></p>
                                </div>
                                <button style={{
